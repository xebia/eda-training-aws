...
import com.xebia.eda.EdaInventoryApplication;
...
@SpringBootTest(classes = {EdaInventoryApplication.class})
@ComponentScan(basePackages = { "com.xebia.common.*", "com.xebia.eda.*" })
@ActiveProfiles({"default", "test"})
public class EdaInventoryControllerTests {
    ...
    public void shouldClaimInventory() throws Exception {
        ...
        MvcResult response = mockMvc.perform(post("/inventory-api/v2/claims")
