...
public class DomainSamples {
    ...
    public static Customer CUSTOMER_1 = new Customer(1L, "John Doe", "abc@efg.nl", "0612345678", true, true, new Address("Sesamstraat", "5b", "3456AB", "Amsterdam", "Netherlands"));
    public static Customer CUSTOMER_2 = new Customer(2L, "Dave Burk", "dave@burk.nl", "0612345679", true, false, new Address("Beathovenlaan", "4", "4532AB", "Rotterdam", "Netherlands"));
    
    public static Order createInitialOrder(int lineCount) {
        Order order = new Order(CUSTOMER_1.getId(), OrderState.INITIATED, SHIPPING_ADDRESS_1);
